...
import dev1 from "../assets/crycode.png";
  ...
  return (
    <div className="events">
      <div className="digital-right">
        ...
        <h1 className="digital-title">Upcoming Events</h1>
      </div>
      <div className="Upcoming">
        <div className="Upcoming-item">
          <h3 className="upcoming-title">16</h3>
          <p className="upcoming-title1">April 2019</p>
          <h3 className="upcoming-title2">Ethyl Voting</h3>
          <p className="upcoming-des">
            “The Ethyl Community Fund Proposal has started their voting.”
          </p>
          <div className="upcoming-btn">Read more</div>
        </div>
        <div className="Upcoming-item">
          <h3 className="upcoming-title">30</h3>
          <p className="upcoming-title1">May 2019</p>
          <h3 className="upcoming-title2">Chainges Conference</h3>
          <p className="upcoming-des">
            Join the first world-class quality blockchain and cryptocurrency
            conference
          </p>
          <div className="upcoming-btn-y">Read more</div>
        </div>
        <div className="Upcoming-item">
          <h3 className="upcoming-title">10</h3>
          <p className="upcoming-title1">June 2019</p>
          <h3 className="upcoming-title2">Ethyl Voting</h3>
          <p className="upcoming-des">
      ...
      <div className="digital-right">
        ...
        <h1 className="digital-title">Donate to Support Development</h1>
      ...
      <div className="donate">
        <div className="donate-item">
          ...
          <div className="donate-center">
            <h2 className="donate-title">177r3vCAH3AzABiQjFPmcrSCp6TDzEDuB1</h2>
            <p className="donate-des">Lymcoin Wallet Address</p>
          </div>
