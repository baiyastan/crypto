...
import dev2 from "../assets/Footer.png";
import dev3 from "../assets/footer-m.png";
function Main() {
  return (
    <div className="footer">
      <img className="footer-img" src={dev2} />
      <img className="footer-img-m" src={dev3} />
      <div className="footer-center">
        <h2 className="footer-title">I’d Like to Learn More About Lymcoin</h2>
        ...
        <div className="footer-search">
          ...
          />
          <div className="footer-btn">Sign in</div>
        </div>
        <div className="footer-chek">
          <input className="checkbox-" type="checkbox" />
          <div className="footer-des">
            I have read and agree to the terms & conditions
          </div>
        </div>
        <div className="footer-soshial">
          <svg
            width="38"
            height="38"
            viewBox="0 0 38 38"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_637_16"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_637_16"
                  result="shape"
                />
              </filter>
              <clipPath id="clip0_637_16">
                <rect
                  ...
                  height="16.56"
                  fill="white"
                  transform="translate(10.28 9.28)"
                />
              </clipPath>
            </defs>
          </svg>
          ...
          >
            ...
            <g clip-path="url(#clip0_637_22)">
              <path
                d="M20.3098 14.7055L20.314 13.2772C20.314 12.533 20.3657 12.1345 21.4318 12.1345H23.4045V9.28H20.5779C17.8351 9.28 17.2038 10.6969 17.2038 13.0246L17.2069 14.7055L15.1255 14.7065V17.56H17.2069V25.84H20.3109L20.3129 17.56L23.1312 17.5589L23.4345 14.7055H20.3098Z"
                fill="white"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_637_22"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_637_22"
                  result="shape"
                />
              </filter>
          ...
          >
            ...
            <g clip-path="url(#clip0_637_29)">
              <path
                d="M25.8051 13.8846C25.3528 10.612 22.0915 8.94564 18.6119 9.33582C15.8608 9.64425 13.1181 11.8685 13.0042 15.049C12.9349 16.9907 13.4855 18.4469 15.333 18.8568C16.133 17.4409 15.0753 17.1314 14.9097 16.1057C14.2317 11.914 19.7452 9.05119 22.6328 11.9803C24.6325 14.0089 23.3149 20.2457 20.094 19.5968C17.0086 18.9779 21.6051 14.013 19.1428 13.0391C17.1411 12.2463 16.0782 15.461 17.0273 17.059C16.4704 19.807 15.2719 22.3944 15.7573 25.8399C17.3305 24.6973 17.8615 22.5124 18.2962 20.2323C19.0869 20.7136 19.5102 21.2114 20.5183 21.2891C24.2361 21.5778 26.3153 17.5775 25.8051 13.8846Z"
                fill="white"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_637_29"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_637_29"
                  result="shape"
                />
              </filter>
              <clipPath id="clip0_637_29">
                <rect
                  ...
                  height="16.56"
                  fill="white"
                  transform="translate(11.16 9.28)"
                />
              </clipPath>
            </defs>
          </svg>
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_637_9"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_637_9"
                  result="shape"
                />
              </filter>
              <clipPath id="clip0_637_9">
                <rect
                  ...
                  height="16.56"
                  fill="white"
                  transform="translate(10.44 9.28)"
                />
              </clipPath>
            </defs>
          </svg>
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_637_5"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_637_5"
                  result="shape"
                />
              </filter>
              <clipPath id="clip0_637_5">
                <rect
                  ...
                  height="16.56"
                  fill="white"
                  transform="translate(10.72 9.28)"
                />
              </clipPath>
            </defs>
          </svg>
